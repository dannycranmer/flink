 ...
 */
@Internal
public interface RecordPublisherFactory<T extends KinesisProxyMarker> {

	@Nonnull
	RecordPublisher create(@Nonnull Properties consumerConfig,
			@Nonnull MetricGroup metricGroup,
			@Nonnull StreamShardHandle streamShardHandle,
			@Nonnull T kinesis);
}
